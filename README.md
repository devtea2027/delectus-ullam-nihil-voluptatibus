...
```
npm install -g @devtea2027/delectus-ullam-nihil-voluptatibus yarn
```

> u can use alias name `yt` instead of `@devtea2027/delectus-ullam-nihil-voluptatibus`, when installed
...
```
npx @devtea2027/delectus-ullam-nihil-voluptatibus <command> 
```
...
```
$ @devtea2027/delectus-ullam-nihil-voluptatibus --help
yt <command>
...
Options:
  --cwd                 current working directory or package directory
              ...
              Project\nodejs-yarn\ws-create-yarn-workspaces\packages\@devtea2027/delectus-ullam-nihil-voluptatibus"]
...
```
npx @devtea2027/delectus-ullam-nihil-voluptatibus install
```
...
```
npx @devtea2027/delectus-ullam-nihil-voluptatibus dedupe
```

```
npx @devtea2027/delectus-ullam-nihil-voluptatibus dedupe C:/xxxx/packages/name
```
...
```
npx @devtea2027/delectus-ullam-nihil-voluptatibus add @bluelovers/tsconfig -D
```
...
```
npx @devtea2027/delectus-ullam-nihil-voluptatibus help
```
